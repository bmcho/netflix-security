...
import com.bmcho.netflix.config.filter.JwtTokenProvider;
import com.bmcho.netflix.controller.NetflixApiResponse;
import com.bmcho.netflix.movie.DownloadMovieUseCase;
import com.bmcho.netflix.movie.FetchMovieUseCase;
import com.bmcho.netflix.movie.LikeMovieUseCase;
...
public class MovieController {
    ...
    public NetflixApiResponse<PageableMoviesBatchResponse> fetchMoviePageable(@PathVariable int page) {
        PageableMoviesBatchResponse pageableMoviesResponse = fetchMovieUseCase.fetchFromClient(page);
